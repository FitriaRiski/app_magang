      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard'); ?>">ADMIN BERITA KELURAHAN</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url('admin/data_mobil'); ?>"><i class="fas fa-book"></i> <span>Berita</span></a></li>

            <li><a class="nav-link" href="<?= base_url('admin/data_tipe'); ?>"><i class="fas fa-grip-horizontal"></i> <span>Jenis Berita</span></a></li>

            <li><a class="nav-link" href="<?= base_url('admin/data_customer'); ?>"><i class="fas fa-users"></i> <span>Data Pengguna</span></a></li>
